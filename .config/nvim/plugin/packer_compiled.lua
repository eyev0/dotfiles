...
_G.packer_plugins = {
  ...
  ["lsp-trouble.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/home/yev/.local/share/nvim/site/pack/packer/opt/lsp-trouble.nvim",
  ...
  ["null-ls.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/home/yev/.local/share/nvim/site/pack/packer/opt/null-ls.nvim",
  ...
  ["nvim-cmp"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/home/yev/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
...
time([[Conditional loading of lsp-trouble.nvim]], true)
  require("packer.load")({"lsp-trouble.nvim"}, {}, _G.packer_plugins)
time([[Conditional loading of lsp-trouble.nvim]], false)
